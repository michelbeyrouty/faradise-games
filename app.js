...
function _initializeFirebase () {
  ...
  serviceAccount = require('./api/constants/admin-account-key.json');

  faradiseGamesApp = firebaseAdmin.initializeApp({
    credential:  firebaseAdmin.credential.cert(serviceAccount),
    databaseURL: 'https://faradise-games.firebaseio.com',
  });
